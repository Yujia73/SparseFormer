...
def main():
    ...
    data_root = './data/Vaihingen/img/'
    ckpt = './Result_Vaihingen/time1003_1911/clcformer_Vaihingen_Best_batch50mF1_8533.pth'
    txt = './data/Vaihingen/test.txt'
    file = open(txt, 'r')

    num_classes=5

    model_name = 'SparseFormer'
    save_root = './prediction/Vaihingen/'
    ...
    model =  SparseFormer(num_classes=5,pretrained=False,attn1='CA',attn2='CBAM').cuda()     
    ...
    for img_path in tqdm(img_paths):
        ...
        rgb_image[test_pred== 0, :] = [255,255,255]
        rgb_image[test_pred== 1, :] = [0,0,255]
        rgb_image[test_pred== 2, :] = [0,255,255]
        rgb_image[test_pred== 3, :] = [0,255,0]
        rgb_image[test_pred== 4, :] = [255,255,0]
        rgb_image[test_pred== 5, :] = [135,255,0]
